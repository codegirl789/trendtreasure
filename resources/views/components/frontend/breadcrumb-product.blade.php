<div class="mb-1 text-base pb-2 text-gray-600">
    ...
    <a href="#">Category</a> <i class="fa-solid fa-angle-right fa-xs px-1 text-gray-400"></i>
    <a href="#">Product</a> <i class="fa-solid fa-angle-right fa-xs px-1 text-gray-400"></i>
    <a href="#" class="">{{ $slot }}</a>
</div>
