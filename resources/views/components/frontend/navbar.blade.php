<div class="py-2 px-4 h-16 hidden md:flex justify-between items-center shadow">
    <div class="relative">
        <input type="text" class="outline-none border-none bg-violet-50 shadow-sm rounded-3xl w-72"
            placeholder="Search Products">
        <i class="fas fa-search absolute right-3 top-3 text-violet-600"></i>
    </div>
    <div class="flex justify-between items-center space-x-4">
        <a href="#" class="px-4 py-2 text-violet-600 bg-violet-50 rounded-3xl shadow-sm text-center">
